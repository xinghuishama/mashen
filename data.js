...
function parseInput(input) {
  ...
  let truncated = false;
  if (results.length > APP_CONFIG.MAX_NUMBERS) {
    results = results.slice(0, APP_CONFIG.MAX_NUMBERS);
    truncated = true;
  }
...
const __GLOBAL__ = typeof window !== "undefined" ? window : (typeof self !== "undefined" ? self : globalThis);
__GLOBAL__.APP_DATA = {
  CONFIG: APP_CONFIG,
  SHENGXIAO,
  CATEGORIES,
